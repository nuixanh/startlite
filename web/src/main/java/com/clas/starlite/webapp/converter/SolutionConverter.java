...
public class SolutionConverter {
    public static SolutionDTO convert(Solution solution){
        ...
        SolutionDTO dto = new SolutionDTO(solution.getId(), solution.getDesc(), solution.getName(), solution.getInfoUrl(), solution.getCaseStudy(), solution.getVideo(), solution.getTrial(), solution.getParentId(), solution.isGroup(), solution.getCreated(), solution.getModified(), solution.getStatus(), solution.getRevision(), solution.getRootParentId(), solution.getPrecedenceIds());
